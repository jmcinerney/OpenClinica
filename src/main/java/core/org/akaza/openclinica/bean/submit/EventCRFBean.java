 ...
 */
package core.org.akaza.openclinica.bean.submit;
...
public class EventCRFBean extends AuditableEntityBean {
    ...
    private core.org.akaza.openclinica.domain.Status nexGenStatus;
    ...
    public EventCRFBean() {
        ...
        nexGenStatus = core.org.akaza.openclinica.domain.Status.INVALID;
    }
    ...
    public core.org.akaza.openclinica.domain.Status getNexGenStatus() {
        return nexGenStatus;
    }

    public void setNexGenStatus(core.org.akaza.openclinica.domain.Status nexGenStatus) {
